...
const AdminPage = () => {
  ...
  return (
    <>
      ...
      />
      <div
        className="relative min-h-screen py-[50px] sm:py-[60px] md:py-[75px] lg:py-[90px] px-[30px] sm:px-[40px] md:px-[70px] lg:px-[100px] bg-[#f2f5f7] transition-[margin-left] duration-[1.2s]"
